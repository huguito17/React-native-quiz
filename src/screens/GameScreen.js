//useState es un hook para el estado y useEffect es otra libreria de hook.
import React, { useState, useEffect } from "react";
import { StyleSheet, Text, View } from "react-native";
import { LinearGradient } from "expo-linear-gradient";
//Importamos el directorio donde interactuamos con la api
...
const GameScreen = ({ route }) => {
    ...
    const handlertStart = () => {
       ...
       //manejo el incremento de las preguntas disponibles
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <QuestionCard
                    question={questions[number].question} //Cualquier atributo JSX se convierte en props (parámetros) 
